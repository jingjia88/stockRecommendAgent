...
async def get_mock_sentiment(text: str) -> str:
    """
    Generate mock sentiment analysis for text.
    
    Args:
        text: Text to analyze
        
    Returns:
        JSON string with mock sentiment analysis
    """
    # Simple keyword-based sentiment simulation
    positive_keywords = ["growth", "profit", "gain", "surge", "optimistic", "strong", "positive", "rally"]
    negative_keywords = ["loss", "decline", "drop", "fall", "pessimistic", "weak", "negative", "crash"]
